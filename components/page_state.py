...
def set_initial_state():
    ...
    if "citation_query_engine" not in st.session_state:
        st.session_state["citation_query_engine"] = None

    if "chat_mode" not in st.session_state:
        st.session_state["chat_mode"] = "refine"

    if "chat_type" not in st.session_state:
        st.session_state["chat_type"] = "Context Only"
